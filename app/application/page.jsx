...
export default function ApplicationForm() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[var(--black)] px-4 py-8">
      <form onSubmit={handleSubmit} className="w-full max-w-4xl bg-[var(--gray-dark)] p-8 rounded-xl shadow-md border border-[var(--gold)]">
        ...
        <div className="flex justify-between items-center mb-6">
            ...
            <button
                onClick={() => router.push('/')}
                type="button"
                className="flex items-center gap-1 text-[var(--gold)] hover:text-[var(--gold-light)]"
            >
                <HomeIcon className="w-5 h-5" />
                <span className="hidden sm:inline">Home</span>
            </button>
            ...
            {/* Title */}
            <h1 className="text-2xl font-bold text-[var(--gold)] text-center mx-4">
                Applicant Information
            </h1>
        ...
        {/* <h1 className="text-2xl font-bold mb-6 text-gray-800 dark:text-white text-center">Applicant Information</h1> */}
        <p className="mb-6 text-[var(--gold)] text-center">
          We respect your privacy and will use the information you provide to determine whether you are a right fit,
          communicate with you, and provide information about our program.
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {/* Left Column */}
          <div className="space-y-4">
            <h2 className="text-lg font-semibold mb-4 text-[var(--gold)]">Personal Information</h2>
            
            <div className="mb-4">
              <label className="block mb-2 text-sm font-medium text-[var(--gold)]">First and Last Name *</label>
              <input
                type="text"
                name="first_last_name"
                value={formData.first_last_name}
                onChange={handleChange}
                required
                className="w-full px-4 py-2 border border-[var(--gold)] rounded-md focus:ring-2 focus:ring-[var(--gold-light)] bg-[var(--black)] text-[var(--gold)]"
              />
            </div>

            <div className="mb-4">
              <label className="block mb-2 text-sm font-medium text-[var(--gold)]">Date of Birth *</label>
              <input
                type="date"
                name="date_of_birth"
                value={formData.date_of_birth}
            ...
            <div className="mb-4">
              <label className="block mb-2 text-sm font-medium text-[var(--gold)]">Address *</label>
              <input
                type="text"
                name="address"
                value={formData.address}
            ...
            <div className="mb-4">
              <label className="block mb-2 text-sm font-medium text-[var(--gold)]">City, State, ZIP *</label>
              <input
                type="text"
                name="city_state_zip"
                value={formData.city_state_zip}
            ...
            <div className="mb-4">
              <label className="block mb-2 text-sm font-medium text-[var(--gold)]">Email *</label>
              <input
                type="email"
                name="email"
                value={formData.email}
            ...
            <div className="mb-4">
              <label className="block mb-2 text-sm font-medium text-[var(--gold)]">Cell Phone *</label>
              <input
                type="tel"
                name="cell_phone"
                value={formData.cell_phone}
          ...
          {/* Right Column */}
          <div className="space-y-4">
            <h2 className="text-lg font-semibold mb-4 text-[var(--gold)]">Occupation Information</h2>
            
            <div className="mb-4">
              <label className="block mb-2 text-sm font-medium text-[var(--gold)]">Target Monthly Income *</label>
              <select
                name="target_monthly_income"
                value={formData.target_monthly_income}
                onChange={handleChange}
            ...
            {/* Then update your select fields like this: */}
            <div className="mb-4">
            <label className="block mb-2 text-sm font-medium text-[var(--gold)]">Current Annual Income *</label>
            <select
                name="current_annual_income"
                value={formData.current_annual_income}
                onChange={handleChange}
            ...
            <div className="mb-4">
              <label className="block mb-2 text-sm font-medium text-[var(--gold)]">Target Annual Income *</label>
              <select
                name="target_annual_income"
                value={formData.target_annual_income}
                onChange={handleChange}
            ...
            <div className="mb-4">
              <label className="block mb-2 text-sm font-medium text-[var(--gold)]">Biggest Obstacle *</label>
              <textarea
                name="biggest_obstacle"
                value={formData.biggest_obstacle}
                onChange={handleChange}
            ...
            <div className="mb-4">
              <label className="block mb-2 text-sm font-medium text-[var(--gold)]">Investment Willingness *</label>
              <select
                name="investment_willingness"
                value={formData.investment_willingness}
                onChange={handleChange}
        ...
        {/* Bottom Section */}
        <div className="mt-6 space-y-4">
          <h2 className="text-lg font-semibold mb-4 text-[var(--gold)]">Program Expectations</h2>
          
          <div className="mb-4">
            <label className="block mb-2 text-sm font-medium text-[var(--gold)]">Expected Accomplishments *</label>
            <textarea
              name="expected_accomplishments"
              value={formData.expected_accomplishments}
              onChange={handleChange}
          ...
          <div className="mb-4">
            <label className="block mb-2 text-sm font-medium text-[var(--gold)]">Start Timeline *</label>
            <select
              name="start_timeline"
              value={formData.start_timeline}
              onChange={handleChange}
          ...
          <div className="mb-6">
            <label className="block mb-2 text-sm font-medium text-[var(--gold)]">Referral Source *</label>
            <select
              name="referral_source"
              value={formData.referral_source}
              onChange={handleChange}
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full py-2 px-4 bg-[var(--gold)] hover:bg-[var(--gold-light)] text-[var(--black)] font-semibold rounded-md disabled:opacity-50"
          >
            {loading ? 'Submitting...' : 'Submit Application'}
          </button>
        </div>
